...
public class BuilderPattern {
	public static void main(String[] args) {
		SmartPhone phone1 = new SmartPhone.BuildPhone().setCamera("108 MP").setProcessor("Snapdragon").setRam("8gb")
				.setStorage("256gb").build();
		System.out.println(phone1);
		SmartPhone phone2 = new SmartPhone.BuildPhone().setCamera("64 MP").setProcessor("Mediatek").setRam("6gb")
				.setStorage("128gb").build();
